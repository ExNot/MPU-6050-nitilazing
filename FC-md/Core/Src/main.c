...
/* USER CODE BEGIN PV */
uint8_t data;
uint8_t buffer[2],tuffer[6],cuffer[6];  //Ham acc ve gyro degerlerinin tutuldugu listeler
int16_t gyro_raw[3],acc_raw[3]; //anlamlandırılmıs ham degerler
float gyro_cal[3]; //kalibrasyon offsetlerini tutan liste
